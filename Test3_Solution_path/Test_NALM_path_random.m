...
%% edgp_mat = the matrix whose each row is the number of the spaced 
%%            grid points of lambda for a given k
%% =================================================================
clear all; clc;
rng('default');
HOME = pwd;
...
%profile on
%================================== Input =================================
m_vec = 500;%[500 1000 3000];
n_vec = 1000;%[100000 200000 500000];
edgp_vec = 5;%[15 30 45;15 30 45;30 60 90]; 
%==========================================================================
