%%=========================================================================
%% Test a solution path for the warm-started N-ALM on UCI data
%%=========================================================================
clear all; clc;
rng('default');
%%
...
pathname = [HOME,filesep,'Result_solution_path_figure_UCI',...
    filesep,'Result_warm_NALM_path_UCI',filesep];
...
for pp = 1:lenprob
    ...
    for qq = 1:lengp
        ...
        eval(['filename_time = ''new_Result_warm_NALM_',num2str(m),'_',num2str(n),'_',num2str(edgp),''';']);
...
%profile viewer
% profsave(profile('info'),'profile_SNIPAL_10_lamc4')
