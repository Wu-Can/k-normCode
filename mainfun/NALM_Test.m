...
function [obj,x,z,u,runhist,info] = NALM_Test(Ainput,b,OPTIONS)
%%
%% Input parameters
%%
tol = 1e-6;
...
%         %-------------------------
        ...
        if alpha < tiny; breakyes =11; break; end
        ...
        %----------test------------
        runhistsub.r_indexJ(itersub) = parsub.r_indexJ;
        %--------------------------
...
%             end
    ...
    runhist.r_indexJ(iter) = mean(runhistsub.r_indexJ);
    %---------------------------
