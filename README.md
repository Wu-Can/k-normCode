...
***Step 3***. Generate the expanded UCI datasets as follows:

  - Download and unpack the four large-scale datasets [E2006.test](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/E2006.test.bz2), [E2006.train](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/E2006.train.bz2), [log1p.E2006.train](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/log1p.E2006.train.bz2) and [log1p.E2006.test](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/log1p.E2006.test.bz2);
  - Put them into the folder `\genUCIdatafun\UCIdataorg`;
  - Run *genUCIdata.m*, then the expanded UCI datasets in MAT format will be generated in the folder `UCIdata`. 

***Step 4***. Run the scripts for generating the corresponding results on UCI data in paper according the following table:
